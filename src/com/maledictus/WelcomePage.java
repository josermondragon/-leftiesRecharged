...
public class WelcomePage extends JFrame{
    ...
    private static final String IMG_PATH = "-leftiesRecharged/resources/data/imageIntro.jfif";
    private static final String IMG_PATH2 = "-leftiesRecharged/resources/data/instructions.PNG";
    ...
    public static void Instructions() {
        try {
            ...
            close2.addActionListener(e -> {f1.dispose();});
