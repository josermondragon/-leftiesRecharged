...
//        panel1.add(textScrollPane(jta),abc);
        ...
        img = new ImageIcon(WelcomePage.class.getClassLoader().getResource("data/commands.png")); //***
...
//        JLabel showImage2 = new JLabel(options);
        ...
        img2 = new ImageIcon(WelcomePage.class.getClassLoader().getResource("data/options.png")); //***
